...
#[tokio::test]
async fn test_transfer_missing_mandatory() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Create transfer request with missing mandatory field
    let request = TransferRequest {
        customer_reference: "".to_string(), // Missing mandatory field
