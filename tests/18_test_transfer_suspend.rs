...
#[tokio::test]
async fn test_transfer_suspend() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let request = TransferRequest {
        customer_reference: "123456789".to_string(),
        sender_identity_number: "3515085211930002".to_string(),
        source_account_no: "1234567890".to_string(),
        amount: Amount {
    ...
    assert!(err_string.contains("4038016"));
    assert!(err_string.contains("Suspend Transaction"));
