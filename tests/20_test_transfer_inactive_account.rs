...
#[tokio::test]
async fn test_transfer_inactive_account() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let request = TransferRequest {
        ...
        source_account_no: "66666".to_string(),
        amount: Amount {
    ...
    assert!(err_string.contains("4038018"));
    assert!(err_string.contains("Inactive Card/Account/Customer"));
