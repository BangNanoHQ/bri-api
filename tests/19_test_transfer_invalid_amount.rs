...
#[tokio::test]
async fn test_transfer_invalid_amount() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let request = TransferRequest {
        customer_reference: "88888".to_string(),
        sender_identity_number: "3515085211930002".to_string(),
        source_account_no: "13560".to_string(),
        amount: Amount {
            value: "23.00".to_string(),
            currency: "IDR".to_string(),
        },
        beneficiary_bank_code: "CENAIDJA".to_string(),
        beneficiary_account_no: "55555".to_string(),
    ...
    assert!(err_string.contains("4048013"));
    assert!(err_string.contains("Invalid Amount"));
