...
#[tokio::test]
async fn test_transfer_dormant_account() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let request = TransferRequest {
        ...
        source_account_no: "77777".to_string(),
        amount: Amount {
    ...
    assert!(err_string.contains("4038009"));
    assert!(err_string.contains("Dormant Account"));
