...
#[tokio::test]
async fn test_transfer_general_error() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Create transfer request that will trigger general error
    let request = TransferRequest {
        customer_reference: "33333".to_string(), // Reference that triggers general error
    ...
    assert!(err_string.contains("5008000"));
